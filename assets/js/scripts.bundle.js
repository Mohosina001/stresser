...
var KTKBootstrapTouchspin = function () {
    ...
    var demos = function () {
        // time setup
        $('#time_touch, .time_touch').TouchSpin({
            buttondown_class: 'btn btn-icon btn-active-color-gray-700 position-absolute translate-middle-y top-50 start-0',
            buttonup_class: 'btn btn-icon btn-active-color-gray-700 position-absolute translate-middle-y top-50 end-0',
            min: 0,
            max: 100000,
            step: 300,
            boostat: 300,
        ...
        $('#timeplan_touch, .timeplan_touch').TouchSpin({
            buttondown_class: 'btn btn-sm  btn-icon btn-active-color-gray-700 position-absolute translate-middle-y top-50 start-0',
            buttonup_class: 'btn btn-sm  btn-icon btn-active-color-gray-700 position-absolute translate-middle-y top-50 end-0',
            min: 3600,
            max: 100000,
            step: 100,
            boostat: 10,
        ...
        // minimum setup
        $('#slots_touch, .slots_touch').TouchSpin({
            buttondown_class: 'btn btn-sm  btn-icon btn-active-color-gray-700 position-absolute translate-middle-y top-50 start-0',
            buttonup_class: 'btn btn-sm  btn-icon btn-active-color-gray-700 position-absolute translate-middle-y top-50 end-0',
            min: 0,
            max: 100000,
        ...
        // minimum setup
        $('#price_touch, .price_touch').TouchSpin({
            buttondown_class: 'btn btn-icon btn-active-color-gray-700 position-absolute translate-middle-y top-50 start-0',
            buttonup_class: 'btn btn-icon btn-active-color-gray-700 position-absolute translate-middle-y top-50 end-0',
